...
<body>
    ...
    <h1>Painel de Administrador</h1>
	    ...
	    <div class="botoes">
	        <a href="adminClientes.jsp"><i class="fa-solid fa-user"></i><span>Clientes</span></a>
	        <a href="adminVeiculos.jsp"><i class="fa-solid fa-car-side"></i><span>Veículos</span></a>
	        <a href="dadosXML.jsp"><i class="fa-solid fa-file-export"></i><span>Dados</span></a>
	    </div>
