...
<body>
    <header>
        ...
        <h1>Painel de Gerente</h1>
	    <h2>Escolha uma das opções abaixo:</h2>
	    <div class="botoes">
	        <a href="historicoVeiculo.jsp"><i class="fa-solid fa-truck-pickup"></i><span>Historico Veiculos</span></a>
	        <a href="rankings.jsp"><i class="fa-solid fa-car-side"></i><span>Rankings</span></a>
	    </div>
