...
<body>
    <header>
        ...
        <div class="iconesPaginaInicial">
            ...
            <a href="condutor.jsp"><i class="fa-solid fa-car"></i><span>Condutor</span></a>
    ...
    <div class="texto">
        <h1>Painel de Condutor</h1>
	    <h2>Escolha uma das opções abaixo:</h2>
	    <div class="botoes">
	        <a href="levantarVeiculo.jsp"><i class="fa-solid fa-user"></i><span>Levantar Veiculo</span></a>
	        <a href="entregarVeiculo.jsp"><i class="fa-solid fa-car-side"></i><span>Entregar Veiculo</span></a>
	    </div>
